...
#             self.position_embedding = nn.Embedding(max_seq_len, embedding_dim)
#             final_embedding = word_embedding(input_ids) + position_embedding(position_ids)
...
def main():
    ...
    train_dataset = StanceDataset(train_df["Text"].tolist(), train_df["Target 1"].tolist(), train_df["label_encoded"].tolist(), word_to_idx)
    val_dataset = StanceDataset(val_df["Text"].tolist(), val_df["Target 1"].tolist(), val_df["label_encoded"].tolist(), word_to_idx)
    test_dataset = StanceDataset(test_df["Text"].tolist(), test_df["Target 1"].tolist(), test_df["label_encoded"].tolist(), word_to_idx)
