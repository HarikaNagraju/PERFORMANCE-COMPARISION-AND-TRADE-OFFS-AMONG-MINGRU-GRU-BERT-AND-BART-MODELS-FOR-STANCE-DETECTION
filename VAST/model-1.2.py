...
def main():
    ...
    train_dataset = StanceDataset(train_df["Tweet"].tolist(), train_df["Target 1"].tolist(), train_df["label_encoded"].tolist(), word_to_idx)
    val_dataset = StanceDataset(val_df["Tweet"].tolist(), val_df["Target 1"].tolist(), val_df["label_encoded"].tolist(), word_to_idx)
    test_dataset = StanceDataset(test_df["Tweet"].tolist(), test_df["Target 1"].tolist(), test_df["label_encoded"].tolist(), word_to_idx)
