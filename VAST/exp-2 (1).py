...
def main():
    ...
    # Load data
    train_df = pd.read_csv("VAST_train_11k.csv")
    val_df = pd.read_csv("VAST_val.csv")
    test_df = pd.read_csv("VAST_test.csv")
    ...
    print("✅ Full experiment results saved at: experiment_results/min_gru_attention_glove.json")
