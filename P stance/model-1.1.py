...
def main():
    ...
    # Datasets
    train_dataset = StanceDataset(train_df["Tweet"].tolist(), train_df["Target"].tolist(),
                                   train_df["label_encoded"].tolist(), word_to_idx)
    val_dataset = StanceDataset(val_df["Tweet"].tolist(), val_df["Target"].tolist(),
                                 val_df["label_encoded"].tolist(), word_to_idx)
    test_dataset = StanceDataset(test_df["Tweet"].tolist(), test_df["Target"].tolist(),
    ...
    with open("experiment_results/min_gru_basic_attention_glove.json", "w") as f:
        json.dump(results, f, indent=4)
    print("✅ Full experiment results saved at: experiment_results/min_gru_basic_ttention_glove.json")
