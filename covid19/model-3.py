...
#     df["text"] = df["Target 1"] + " [SEP] " + df["Tweet"]
...
#     # ROC Curve
#     y_true_bin = np.eye(len(class_names))[labels]
#     y_pred_bin = np.eye(len(class_names))[preds]
#     plt.figure(figsize=(10, 8))
#     for i, class_name in enumerate(class_names):
...
#     # Save results
#     save_bert_results_and_visuals(preds, labels, class_names, eval_metrics)

#     print("\n✅ Completed! All results saved in the output folder.")
